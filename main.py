...
async def startup_event():
    ...
    success = load_model_and_metadata()  # Replace with actual function call
    if not success:
...
async def health_check():
    ...
    health_status = check_health()  # Replace with actual function call
...
async def model_info():
    ...
    try:
        ...
        info = get_model_info()  # Replace with actual function call
...
async def predict(request: HousePredictionRequest):
    ...
    try:
        ...
        predicted_price = make_prediction(features_dict)  # Replace with make_prediction() call

        # YOUR TASK: Get model version from metadata
        # You'll need to call get_model_info() to get the version
        metadata= get_model_info()  # Replace with actual function call
        model_version = metadata["version"]  # Replace with actual version from metadata
